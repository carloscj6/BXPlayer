...
public class BXCurrentSong {
    static final BXCurrentSong EMPTY_SONG = new BXCurrentSong("", -1, -1,
            -1, null, "", -1, "");
    ...
    final int year;
    public BXCurrentSong(final String title, final int trackNumber, final int year, final int duration,
