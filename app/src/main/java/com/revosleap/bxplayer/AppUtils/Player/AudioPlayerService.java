...
MediaPlayer.OnInfoListener,AudioManager.OnAudioFocusChangeListener{
    ...
    private void updateMetaData() {
        ...
        if (AudioUtils.cover(activeAudio.getPath())!=null){
            cover=AudioUtils.cover(activeAudio.getPath());
        }else cover=albumArt;
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
         ...
         notificationBuilder = notificationBuilder
            ...
            //    .addInvisibleAction(R.drawable.ic_if_close,"cancel",playbackAction(4))
         ;
