...
public class EqualizerUtils {
    ...
    public static void openAudioEffectSession(@NonNull final Context context, final int sessionId) {
    ...
    public static void closeAudioEffectSession(@NonNull final Context context, final int sessionId) {
    ...
    public static void openEqualizer(@NonNull final Activity activity, MediaPlayer mediaPlayer) {
